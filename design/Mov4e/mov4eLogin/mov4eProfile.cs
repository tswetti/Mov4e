...
namespace Mov4e
{
    public partial class mov4eProfile : Form
    {
        ...
        private void tableLayoutPanelProfileContent_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            this.Hide();
            mov4eProfileSettings m = new mov4eProfileSettings();
            m.FormClosed += (s, args) => this.Close();
            m.ShowDialog();
        }
        ...
        private void tableLayoutPanelProfileInformation_Paint(object sender, PaintEventArgs e)
        {
